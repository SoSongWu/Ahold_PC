...
<body>
	<div class="wrap">
		...
		<div class="home_info" id="home_devteam">
			<ul>
				<li><em>皇家阿霍德</em> <a href="http://www.aholdhk.com" target="_blank">www.aholdhk.com</a></li>
				<li><em>核心开发者</em> <span>小吴,大龙</span></li>
				<li><em><?php echo L('TEAM_MEMBERS');?></em> <span>小吴,大龙</span></li>
				<li><em><?php echo L('CONTACT_EMAIL');?></em> <span>aholdhk@aliyun.com</span></li>
			</ul>
		</div>
		...
		<div class="">
			<ul class="inline" style="margin-left: 25px;">
				...
				<li><a href="http://www.aholdhk.com/" target="_blank">Wu</a></li>
				<li><a href="http://www.aholdhk.com/" target="_blank">long</a></li>
