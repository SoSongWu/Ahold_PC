...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="/themes/simplebootx/Public/assets/css/oneindexcss/swiper.min.css">
		<link rel="stylesheet" href="/themes/simplebootx/Public/assets/css/oneindexcss/bootstrap.min.css">
		<link rel="stylesheet" href="/themes/simplebootx/Public/assets/css/oneindexcss/style.min.css">
		<link rel="stylesheet" href="/themes/simplebootx/Public/assets/css/oneindexcss/layer.css" id="layuicss-skinlayercss">
		<link rel="stylesheet" href="/themes/simplebootx/Public/assets/css/oneindexcss/bideo.css" />
		<script src="/themes/simplebootx/Public/assets/js/oneindexjs/bideo.js"></script>
		<script src="/themes/simplebootx/Public/assets/js/oneindexjs/main.js"></script>
		<script src="/themes/simplebootx/Public/assets/js/oneindexjs/jquery-3.2.1.min.js"></script>
		<script src="/themes/simplebootx/Public/assets/js/oneindexjs/swiper.jquery.min.js"></script>
		<script src="/themes/simplebootx/Public/assets/js/oneindexjs/tether.min.js"></script>
		<script src="/themes/simplebootx/Public/assets/js/oneindexjs/bootstrap.min.js"></script>
		<script src="/themes/simplebootx/Public/assets/js/oneindexjs/layer.js"></script>
		<script src="/themes/simplebootx/Public/assets/js/oneindexjs/browserDetect.min.js"></script>
	...
	<body>
		...
		<nav class="navbar navbar-toggleable-md  navbar-toggler-center navbar-inverse bg-inverse main-navbar">
            ...
            <span class="navbar-toggler-icon"></span>
				...
				<a class="navbar-brand" href="javascript:void(0)"><img  style="height:50px;width: 300px; margin: -10px;" title="皇家阿霍德" alt="皇家阿霍德" src="/themes/simplebootx/Public/assets/images/oneindexpic/皇家阿霍德.png "></a>
						...
						<div class="page-container about">
							...
							<div class="tab-content pt-5">
								<div class="tab-pane active" id="about-company" role="tabpanel">
									...
									<div class="row mt-5  d-flex align-items-center">
										...
										<div class="col-md-4 col-sm-12 text-center">
											<div>
												<img src="/themes/simplebootx/Public/assets/images/oneindexpic/acba4517660e73e570eced10f1e71f5b.png">
											</div>
											<h4>
								...
								<div class="tab-pane" id="about-team" role="tabpanel">
									...
									<div class="mt-3 ">
										<h3>阿霍德目标：阿霍德帮助合作商家共赢</h3>
										<h3>阿霍德方向：阿霍德希望成为中国有史以来最多创业者的领跑者</h3>
										<h3>阿霍德结果：阿霍德要做到中国最强大线上线下的航空母舰</h3>
										<h3>阿霍德愿景：阿霍德打造过百万个老板，成为千万富翁</h3>
									</div>
								</div>
							</div>
						</div>
					...
					<section class="page-wrap page-3">
						<div class="page-container">
							...
							<div class="mt-5 service-list">
								<div class="item">
									<img alt="阿霍德商城_时髦女装" src="/themes/simplebootx/Public/assets/images/oneindexpic\shangpin\时髦女装.jpg" alt="时髦女装">
									<div class="item-text">时髦女装</div>
								</div>
								<div class="item">
									<img alt="阿霍德商城_户外运动" src="/themes/simplebootx/Public/assets/images/oneindexpic\shangpin\户外运动.jpg" alt="户外运动">
									<div class="item-text">户外运动</div>
								</div>
								<div class="item">
									<img alt="阿霍德商城_家居家纺" src="/themes/simplebootx/Public/assets/images/oneindexpic\shangpin\家居家纺.jpg" alt="家居家纺">
									<div class="item-text">家居家纺</div>
								</div>
								<div class="item">
									<img alt="阿霍德商城_美妆个护" src="/themes/simplebootx/Public/assets/images/oneindexpic\shangpin\美妆各户.jpg" alt="美妆各户">
									<div class="item-text">美妆个护</div>
								</div>
								<div class="item">
									<img alt="阿霍德商城_母婴童装" src="/themes/simplebootx/Public/assets/images/oneindexpic\shangpin\母婴童装.jpg" alt="母婴童装">
									<div class="item-text">母婴童装</div>
								</div>
								<div class="item">
									<img alt="阿霍德商城_暖心内衣" src="/themes/simplebootx/Public/assets/images/oneindexpic\shangpin\暖心内衣.jpg" alt="暖心内衣">
									<div class="item-text">暖心内衣</div>
								</div>
								<div class="item">
									<img alt="阿霍德商城_品质男装" src="/themes/simplebootx/Public/assets/images/oneindexpic\shangpin\品质男装.jpg" alt="品质男装">
							...
							<div class="row mt-5">
								<div class="col-md-6 col-sm-12 d-flex mb-4">
									<div class="d-flex">
										<div>
											<p class="h4">
												<img alt="阿霍德商城_地址" src="/themes/simplebootx/Public/assets/images/oneindexpic/icon_location.png">佛山市禅城区智慧新城T6-803 </p>
											<p class="h4">
												<img alt="阿霍德商城_电话" src="/themes/simplebootx/Public/assets/images/oneindexpic/icon_tel.png">400-084-8003 </p>
											<p class="h4">
												<img alt="阿霍德商城_名称" src="/themes/simplebootx/Public/assets/images/oneindexpic/icon_weibo.png">皇家阿霍德商业有限公司 </p>
										</div>
										<div class="pl-md-5 qr">
											<img src="/themes/simplebootx/Public/assets/images/oneindexpic/皇家阿霍德.jpg" alt="皇家阿霍德" height="96">
								...
								<div class="col-md-6 col-sm-12 mb-4">
									<div class="contact-md">
										<div class="d-flex">
											...
											<div class="pl-md-5 qr">
												<img src="/themes/simplebootx/Public/assets/images/oneindexpic/阿霍德商城.jpg" alt="皇家阿霍德" height="96">
